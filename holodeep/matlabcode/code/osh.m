...
function [image0, imagen, imagep Phase] = osh(baseFileName,filename,savetodir)
addpath('lib');
%%Reading input bitmap files

N = 32;

fullSavedFileName = fullfile(savetodir, baseFileName);
...
imwrite(uint8(rgbImage),fullSavedFileName);
